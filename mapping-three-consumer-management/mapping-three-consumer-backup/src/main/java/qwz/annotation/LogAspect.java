...
import static com.qwz.staticproperties.TimeForatProperties.TIME_FORMAT;
...
public class LogAspect {
     ...
     * @throws
    **/
    @Pointcut("@annotation(com.qwz.annotation.LoginAnnotation)")
