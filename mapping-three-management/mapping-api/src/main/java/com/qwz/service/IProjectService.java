...
public interface IProjectService {
    ...
    ResultData selectNews(@RequestParam("title") String title,@RequestParam("pageNumber") Integer pageNumber,
    ...
    ResultData insertNews(@RequestBody Map map);
    ...
    ResultData deleteNews(@RequestParam("ids") String ids);
    ...
    ResultData selectAdm(@RequestParam("projectType") String projectType,@RequestParam("userid") Integer userid,
    ...
    ResultData deleteAdm(@RequestParam("id") Long id);
     ...
     **/
    @PostMapping("/selectAdm")
    ResultData selectRem(@RequestParam("projectType") String projectType,@RequestParam("userid") Integer userid,
                         @RequestParam("pageNumber") Integer pageNumber, @RequestParam("pageSize") Integer pageSize);
    ...
    ResultData selectCheckPerson(@RequestBody HashMap hashMap);
    ...
    ResultData delectOneCheckPerson(@RequestParam("id") String id);
    ...
    ResultData delectListCheckPerson(@RequestParam("ids") String ids);
    ...
    ResultData selectWhiteUnit(@RequestBody HashMap hashMap);
    ...
    ResultData selectBlackUnit(@RequestBody HashMap hashMap);
    ...
    ResultData selectEquipment(@RequestParam("userid") Integer userid,@RequestParam("pageNumber") Integer pageNumber,
                               @RequestParam("pageSize") Integer pageSize);
    ...
    ResultData selectIdEquipment(@RequestParam("id") Long id);
    ...
    ResultData selectOneTec(@RequestParam("id") Long id);

    @PostMapping("/selectSpecial")
    ResultData selectSpecial(@RequestParam("userid") Integer userid,@RequestParam("pageNumber") Integer pageNumber,
                             @RequestParam("pageSize") Integer pageSize);

    @PostMapping("/selectIdSpecial")
    ResultData selectIdSpecial(@RequestParam("id") Long id);
    ...
    ResultData selectResultCommitById(@RequestParam("id") Long id);
    ...
    ResultData selectPersonByuserId(@RequestParam("userId") Integer userId);
     ...
     **/
    @PostMapping("/addUnit")
    ResultData addUnit(@RequestBody Map map);
